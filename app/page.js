...
export default function Home() {
  return (
    <main
      ...
      style={{
        background:
          "url('https://i.pinimg.com/originals/e3/2f/ff/e32fffc3585275e96204c66f56c1efb7.jpg')",
    ...
    >
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 mt-16">
        ...
        <Link
          href="/projects"
          className="bg-yellow-500 text-white px-6 py-3 rounded mt-4 hover:bg-orange-600"
        >
          View My Work
        </Link>
      </section>
